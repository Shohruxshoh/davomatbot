...
API_TOKEN = '7427384403:AAFaSpeWuxH7YQuRVPzZVnuG5ofepfm6rKI'
...
async def send_file(chat_id, filename):
    if os.path.isfile(filename):
        with open(filename, 'r', encoding='utf-8') as file:
            ...
            # Agar fayl mazmuni juda katta bo'lsa, uni qismlarga bo'lib yuborish mumkin
...
async def start_bot(bot: Bot):
    await bot.send_message(104745314, "Bot ishga tushdi!!")


async def shutdown_bot(bot: Bot):
    await bot.send_message(104745314, "Bot o'chdi!!")
